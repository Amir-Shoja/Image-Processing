...
if __name__ == "__main__":
    ...
    img = cv2.imread("Input\meface.jpg")
    ...
    img = zoom_efect(img, landmark_lips)
    img = zoom_efect(img, landmark_left_eye)
    img = zoom_efect(img, landmark_right_eye)

    cv2.imwrite("Output\mefaceresult2.jpg", img)
